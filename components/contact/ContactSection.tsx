...
const ContactSection = () => {
  ...
  return (
    <div className="min-h-screen text-white selection:bg-primary selection:text-white py-16 px-4 md:px-8 lg:px-16 relative overflow-hidden">
      <div className="">
        {/* Bento Grid */}
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
          ...
          <motion.div
            ...
            className="lg:col-span-8 border border-white/5 rounded-[2rem] p-8 md:p-12 relative overflow-hidden"
          >
          ...
          <div className="lg:col-span-4 grid grid-cols-1 gap-6">
            {/* Social Card */}
            <div className="border border-white/5 rounded-4xl p-8 flex flex-col justify-between">
              <div>
                <h3 className="text-sm uppercase tracking-widest mb-6 font-bold">
                  Follow Us
                </h3>
                <div className="flex gap-2">
                  {socialLinkLists.map((socialLinkItem) => (
                    <Link
                      ...
                      className="size-10 rounded-full flex items-center justify-center hover:bg-foreground hover:border-transparent transition-all"
                    >
                      <Icon
                        icon={socialLinkItem.fillIcon}
              ...
              <div className="mt-8">
                <p className="text-sm uppercase tracking-widest mb-2 font-bold">
                  contact
                </p>
                <div className="flex gap-2">
            ...
            {/* Location Card */}
            <div className="bg-[#1a1a1e] border border-white/5 rounded-4xl group transition-colors hover:border-primary/30 grayscale">
              <iframe
