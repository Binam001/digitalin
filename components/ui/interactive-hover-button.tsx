...
>(
  (
    { text = "Button", icon, className, iconClassName, dotClassName, ...props },
    ref
  ) => {
    return (
      <button
      ...
      >
        ...
        <div
          className={cn(
            "absolute left-[10%] top-[40%] h-2 w-2 scale-[1] rounded-lg bg-primary transition-all duration-300 group-hover:left-[0%] group-hover:top-[0%] group-hover:h-full group-hover:w-full group-hover:scale-[1.8] group-hover:bg-primary",
            dotClassName
          )}
        ></div>
      </button>
